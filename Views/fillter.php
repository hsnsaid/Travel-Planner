...
<body>
  ...
  <section class="px-12 py-8">
    <h2 class="mb-3 text-3xl text-center">going to <?php echo htmlspecialchars($data["search"][0]['destination'])?></h2>
      ...
      <?php foreach($data["fillter"] as $search){?>
    <div class="p-3 mb-3 bg-gray-100 rounded-md shadow-md">
      ...
      <a href="link.html"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm.75-11.25a.75.75 0 00-1.5 0v2.5h-2.5a.75.75 0 000 1.5h2.5v2.5a.75.75 0 001.5 0v-2.5h2.5a.75.75 0 000-1.5h-2.5v-2.5z" clip-rule="evenodd" /></svg></a>
    </div>
    <?php }?>
  </section>
</body>
